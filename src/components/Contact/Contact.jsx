...
const Contact = () => {
  ...
  return (
    ...
    <p className='text-gray-400 mt-4 md:text-lg text-md font-semibold'>I’m always open to new opportunities and conversations. Let’s connect and build something amazing together!</p>
    </div>
